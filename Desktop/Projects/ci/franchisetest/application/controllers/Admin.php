...
class Admin extends CI_Controller
{
    ...
    public function instructor_form($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add_instructor_form') {
            $page_data['page_name'] = 'franchise_add';
...
//   Franchise modelling //
    ...
    public function franchises($param1 = "", $param2 = "")
    {
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        if ($param1 == "add") {
            $this->user_model->add_franchise(); // PROVIDING TRUE FOR INSTRUCTOR
            redirect(site_url('admin/franchises'), 'refresh');
        } elseif ($param1 == "edit") {
            $this->user_model->edit_franchise($param2);
            redirect(site_url('admin/franchises'), 'refresh');
        } elseif ($param1 == "delete") {
            $this->user_model->delete_user($param2);
            redirect(site_url('admin/franchises'), 'refresh');
        ...
        $page_data['page_name'] = 'franchises';
        $page_data['page_title'] = 'franchise';
        $page_data['franchises'] = $this->user_model->get_franchise()->result_array();
        $this->load->view('backend/index', $page_data);
    }

    public function franchise_form($param1="", $param2=""){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        check_permission('user');
        check_permission('instructor');
        if ($param1 == 'add_franchise_form') {
            $page_data['page_name'] = 'franchise_add';
            $page_data['page_title'] = get_phrase('franchise add');
            $this->load->view('backend/index', $page_data);
    ...
    public function save_price($param1){

        $this->user_model->update_price($param1);
    }

    public function customers($param1="", $param2=""){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
       
        if($param1=='view_customers'){
            $page_data['page_name'] = 'customers';
            $page_data['page_title'] = 'List of Customers';
            $page_data['data'] = $this->user_model->get_customer()->result_array();
            $this->load->view('backend/index',$page_data);
        }
        ...
        if($param1=='invoices'){
            ...
            $page_data['data'] = $this->user_model->get_invoice()->result_array();
            $this->load->view('backend/index', $page_data);
        }
    ...
    public function application($param1 = "", $param2 = ""){
        if($param1 == 'pending'){
            $page_data['page_name'] = 'view_application';
            $page_data['page_title'] = 'Pending Application';
            $page_data['data'] = $this->user_model->get_application_by_status($param1)->result_array();
            $this->load->view('backend/index', $page_data);
        }elseif($param1 == 'proccessing'){
            $page_data['page_name'] = 'view_application';
            $page_data['page_title'] = 'Proccessing Application';
            $page_data['data'] = $this->user_model->get_application_by_status($param1)->result_array();
            $this->load->view('backend/index', $page_data);
        }elseif($param1 == 'verfication'){
            $page_data['page_name'] = 'view_application';
            $page_data['page_title'] = 'Proccessing Application';
            $page_data['data'] = $this->user_model->get_application_by_status($param1)->result_array();
            $this->load->view('backend/index', $page_data);
        }elseif($param1 == 'completed'){
            $page_data['page_name'] = 'view_application';
            $page_data['page_title'] = 'Proccessing Application';
            $page_data['data'] = $this->user_model->get_application_by_status($param1)->result_array();
            $this->load->view('backend/index', $page_data);
        }elseif($param1 == 'cancelled'){
            $page_data['page_name'] = 'view_application';
            $page_data['page_title'] = 'Proccessing Application';
            $page_data['data'] = $this->user_model->get_application_by_status($param1)->result_array();
            $this->load->view('backend/index', $page_data);
        }elseif($param1 == 'doc_error'){
            $page_data['page_name'] = 'view_application';
            $page_data['page_title'] = 'Proccessing Application';
            $page_data['data'] = $this->user_model->get_application_by_status($param1)->result_array();
            $this->load->view('backend/index', $page_data);
    ...
    public function save_status($param1 = "", $param2 = ""){
        if(!empty($param1)){
            $this->user_model->update_status($param1);
            redirect(site_url('admin/dashboard'));
        }
    }

    public function download_zip_file($param1=""){
        if(!empty($param1)){

            $this->load->helper('download');

            $file_url = json_decode($this->user_model->get_zip_attachment_url($param1));
            force_download($file_url[1], NULL);
    ...
    public function service($param1 = "", $param2 = ""){
        ...
        if($param1=="view_services"){

            $page_data['page_name'] = 'view_services';
            $page_data['page_title'] = "All services";
            $this->load->view('backend/index', $page_data);
        }
    ...
    public function view_service_detail($param1 = "", $param2 = ""){
         if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
    ...
    public function addon($param1 = "", $param2 = "", $param3 = "")
    {
        ...
        // CHECK ACCESS PERMISSION
        check_permission('addon');if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
