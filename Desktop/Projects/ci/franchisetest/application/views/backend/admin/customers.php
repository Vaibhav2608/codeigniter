                    ...
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo 'Active services'; ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($data as $key => $user) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->user_model->get_customer_application($user['id'])->num_rows().' active services';
                                        // echo $this->user_model->get_number_of_active_courses_of_instructor($user['id']) . ' ' . strtolower(get_phrase('active services')); 
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="<?php echo site_url('admin/courses?category_id=all&status=all&instructor_id=' . $user['id'] . '&price=all') ?>"><?php echo get_phrase('View Services'); ?></a></li>
