            ...
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/404'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    <i class="dripicons-archive text-muted" style="font-size: 24px;"></i>
                                    <h3><span><?php echo $number_of_courses; ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('Number of Invoices'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo site_url('admin/404'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('Number of services'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo site_url('admin/404'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('Number of Franchise'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
...
<div class="row">
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4"><?php echo get_phrase('Services Overview'); ?></h4>
                ...
                <div class="row text-center mt-2 py-2">
                    <div class="col-6">
                        ...
                        <p class="text-muted mb-0"><?php echo get_phrase('Active Services'); ?></p>
                    </div>
                    <div class="col-6">
                        ...
                        <p class="text-muted mb-0"> <?php echo get_phrase('Pending Services'); ?></p>
                    </div>
                </div>
            </div>
        </div>
