...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo 'DSC'; ?></h4>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="<?php echo site_url('user/form/view_dsc_form/'.$user['form_id']) ?>"><?php echo get_phrase('View aplication'); ?></a></li>
