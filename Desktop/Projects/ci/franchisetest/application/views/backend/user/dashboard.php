<?php
    ...
    $number_of_customers = $this->user_model->get_franchise_customer($franchise_id)->num_rows();
    $number_of_invoice = $this->user_model->get_invoice($franchise_id)->num_rows();
    $number_of_courses = $this->crud_model->get_instructor_wise_courses($instructor_id)->num_rows();
    $number_of_enrolment_result = $this->user_model->get_franchise_customer($franchise_id);
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4"><?php echo get_phrase('Franchise Revenue'); ?></h4>
                        ...
                        <a href="#" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $number_of_invoice; ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('Number of Customers Invoice'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow-none m-0 border-left">
                            <div class="card-body text-center">
                                ...
                                <h3><span><?php echo $number_of_customers; ?></span></h3>
                                <p class="text-muted font-15 mb-0"><?php echo get_phrase('Number of Customers'); ?></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <a href="<?php echo site_url('user/payout_report'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('Balance in Wallet'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4"><?php echo get_phrase('Application Overview'); ?></h4>
                ...
                <div class="row text-center mt-2 py-2">
                    <div class="col-6">
                        ...
                        <p class="text-muted mb-0"><?php echo get_phrase('Active Application'); ?></p>
                    </div>
                    <div class="col-6">
                        ...
                        <p class="text-muted mb-0"> <?php echo get_phrase('Pending Application'); ?></p>
                    </div>
                </div>
            </div>
        </div>
