        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <span  style="color: #fff;">
                    ...
                    <span class="account-position"><?php echo strtolower($this->session->userdata('role')) == 'user' ? get_phrase('Franchise') : get_phrase('admin'); ?></span>
                </span>
            </a>
            ...
            <div class=" dropdown-header noti-title">
                <h6 class="text-overflow m-0"><?php echo get_phrase('Bye'); ?> !</h6>
            </div>
